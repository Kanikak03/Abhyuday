...
public class MapsActivity extends AppCompatActivity implements GoogleMap.OnMarkerClickListener,
    ...
    private static final LatLng MSRIT = new LatLng(12.9718915, 77.6411545);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(MSRIT, 13));
